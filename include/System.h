...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const bool bDoLoopClosing = true, const bool useTraversability = true, const int initFr = 0, const string &strSequence = std::string());
