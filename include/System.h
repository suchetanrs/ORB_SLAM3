...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const bool bDoLoopClosing = true, const bool useTraversability = true, Eigen::Affine3f tf_SlamToLidar = Eigen::Affine3f(), Eigen::Affine3f tf_BaseToSlam = Eigen::Affine3f(), const int initFr = 0, const string &strSequence = std::string());
